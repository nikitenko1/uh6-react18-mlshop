...
const Description = () => {
  ...
  if (!description?.contentHtml.length) {
    return (
      <div className="bg-white mt-4 p-6 rounded-md aspect-[16/9]">
        <img className="w-full h-full object-cover" src="./no-results-found.png" alt="" />
        <p className="mt-6 text-green-500 text-center">- - - - - - -Updating!- - - - - - -</p>
      </div>
    );
  }
  ...
  return (
    <div className="bg-white mt-4 p-6 rounded-md description">
      <h2 className="font-semibold text-[30px] text-center mb-5">Product Description</h2>
